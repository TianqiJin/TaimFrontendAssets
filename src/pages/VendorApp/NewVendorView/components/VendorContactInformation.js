...
class VendorContactInformation extends React.Component {
    ...
    render() {
        ...
        return <React.Fragment>
            ...
            <Grid container spacing={2} justify={'center'} direction="row">
                <Grid item sm={6}>
                    <TextField value={this.props.vendor.email}
                ...
                <Grid item sm={6}>
                    <TextField value={this.props.vendor.phone}
...
export default withStyles(styles)(VendorContactInformation);