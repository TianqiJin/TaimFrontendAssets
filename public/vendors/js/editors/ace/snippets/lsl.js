...
snippet email\n\
	email(${1:string time}, ${2:string addressDTOS}, ${3:string subject}, ${4:string message}, ${5:integer num_left})\n\
	{\n\
		$0\n\
	}\n\
...
snippet llEjectFromLand\n\
	...
	$0\n\
snippet llEmail\n\
	llEmail(${1:string addressDTOS}, ${2:string subject}, ${3:string message});\n\
	$0\n\
snippet llEscapeURL\n\
...
snippet llGetNextEmail\n\
	llGetNextEmail(${1:string addressDTOS}, ${2:string subject});\n\
	$0\n\
