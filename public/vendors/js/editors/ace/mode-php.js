...
var functionMap = {
    ...
    "dns_check_record": [
        ...
        "Check DNS records corresponding to a given Internet host name or IP addressDTOS"
    ],
    "dns_get_mx": [
    ...
    "gethostbyaddr": [
        ...
        "Get the Internet host name corresponding to a given IP addressDTOS"
    ],
    "gethostbyname": [
        "string gethostbyname(string hostname)",
        "Get the IP addressDTOS corresponding to a given Internet host name"
    ],
    "gethostbynamel": [
    ...
    "imap_rfc822_write_address": [
        ...
        "Returns a properly formatted email addressDTOS given the mailbox, host, and personal info"
    ],
    "imap_savebody": [
    ...
    "inet_ntop": [
        ...
        "Converts a packed inet addressDTOS to a human readable IP addressDTOS string"
    ],
    "inet_pton": [
        "string inet_pton(string ip_address)",
        "Converts a human readable IP addressDTOS to a packed binary string"
    ],
    "ini_get": [
    ...
    "ip2long": [
        ...
        "Converts a string containing an (IPv4) Internet Protocol dotted addressDTOS into a proper addressDTOS"
    ],
    "iptcembed": [
    ...
    "long2ip": [
        ...
        "Converts an (IPv4) Internet network addressDTOS into a string in Internet standard dotted format"
    ],
    "lstat": [
    ...
    "stream_socket_client": [
        ...
        "Open a client connection to a remote addressDTOS"
    ],
